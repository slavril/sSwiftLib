...
extension UILabel {
    ...
    func smallStyle() {
        self.setDefaultFont(10)
        self.textColor = Constant.color.black
    }
    
    func captionBoldStyle() {
        self.setBoldFont(12)
        self.textColor = Constant.color.black
    }
    
    func captionStyle() {
        self.setDefaultFont(12)
        self.textColor = Constant.color.black
    }
    
    func captionStyleGray() {
        self.captionStyle()
        self.textColor = Constant.color.gray
    }
    
    func bodySemiStyle() {
        self.setSemiBoldFont(14)
        self.textColor = Constant.color.black
    }
    
    func bodyStyle() {
        self.setDefaultFont(14)
        self.textColor = Constant.color.black
    }
    
    func subHeaderBoldStyle() {
        self.setBoldFont(16)
        self.textColor = Constant.color.black
    }
    
    func subHeaderSemiStyle() {
        self.setSemiBoldFont(16)
        self.textColor = Constant.color.black
    }
    
    func subHeaderStyle() {
        self.setDefaultFont(16)
        self.textColor = Constant.color.black
    }
    
    func subHeaderLightStyle() {
        self.setLightFont(16)
        self.textColor = Constant.color.black
    }
    ...
    func headlineLightStyle() {
        self.setLightFont(24)
        self.textColor = Constant.color.black
    }
    
    func sectionLightStyle() {
        self.setLightFont(32)
    }
    
    func sectionSemiStyle() {
        self.setSemiBoldFont(34)
        self.textColor = Constant.color.black
    }
